...
package com.example.vibecapandroid.WheelView;
...
import static com.example.vibecapandroid.HomeMainFragmentKt.feeling;
...
import com.example.vibecapandroid.HomeCameraActivity;
import com.example.vibecapandroid.R;
import com.example.vibecapandroid.WheelView.adapter.WheelAdapter;
import com.example.vibecapandroid.WheelView.transformer.FadingSelectionTransformer;
import com.example.vibecapandroid.WheelView.transformer.ScalingItemTransformer;
import com.example.vibecapandroid.WheelView.transformer.WheelItemTransformer;
import com.example.vibecapandroid.WheelView.transformer.WheelSelectionTransformer;
...
public class WheelView extends View {
    ...
    private com.example.vibecapandroid.WheelView.Circle mWheelBounds;

    /**
     * Wheel item bounds are always pre-rotation and based on the {@link #mSelectionAngle}
     */
    private List<com.example.vibecapandroid.WheelView.Circle> mWheelItemBounds;
    ...
    public void setSelectionAngle(float angle) {
        mSelectionAngle = com.example.vibecapandroid.WheelView.Circle.clamp180(angle);
    ...
    private void setWheelBounds(int width, int height) {
        ...
        mWheelBounds = new com.example.vibecapandroid.WheelView.Circle(centerX, centerY, wheelRadius);
    ...
    private void layoutWheelItems() {
        ...
        if (mWheelItemBounds == null) {
            mWheelItemBounds = new ArrayList<com.example.vibecapandroid.WheelView.Circle>(mItemCount);
        ...
        for (int i = 0; i < mItemCount; i++) {
            ...
            mWheelItemBounds.add(new com.example.vibecapandroid.WheelView.Circle(x, y, mItemRadius));
        }
    ...
    public int rawPositionToAdapterPosition(int position) {
        return mIsRepeatable ? com.example.vibecapandroid.WheelView.Circle.clamp(position, mAdapterItemCount) : position;
    }
    ...
    public int rawPositionToWheelPosition(int position, int adapterPosition) {
        ...
        return com.example.vibecapandroid.WheelView.Circle.clamp(adapterPosition + circularOffset, mItemCount);
    }
    ...
    private void drawWheelItems(Canvas canvas) {
        ...
        for (int i = offset; i < length; i++) {
            ...
            com.example.vibecapandroid.WheelView.Circle itemBounds = mWheelItemBounds.get(wheelItemPosition);
    ...
    public static class ItemState {
        ...
        com.example.vibecapandroid.WheelView.Circle mBounds;
        float mAngleFromSelection;
        float mRelativePos;
        int mAdapterPosition; //TODO

        private ItemState() {
            mBounds = new com.example.vibecapandroid.WheelView.Circle();
        }
        ...
        public com.example.vibecapandroid.WheelView.Circle getBounds() {
            return mBounds;
        }
    ...
    private void updateItemState(ItemState itemState, int adapterPosition,
        ...
        float angleFromSelection = com.example.vibecapandroid.WheelView.Circle.shortestAngle(itemAngle, mSelectionAngle);
